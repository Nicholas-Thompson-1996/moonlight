	...
	<form action="create_member.php" method="post">
		...
		<table style="width:100%" align="left">
				...
				<?php
					...
					$i++;
				} //if datatype == this then...
					// for all datatypes.
					//enum and set should always look the same.
					//enum = dropdown box and set = check box...
					//if($data_type_cols[$i] == 'Text')
					//we want text html.
					//else if ($data_type_cols[$i] == 'Single')
					//want varchar.. which is what we have now
					//password if goes here.
					//else if ($data_type_cols[$i] == 'Integer')
				?>		
