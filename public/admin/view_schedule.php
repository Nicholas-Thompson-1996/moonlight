...
//if it has been checked i.e. changed.
//then we will have something.. we then change value.
//if not set.. use previous value.
...
if(isset($_POST['submit'])){
	...
	foreach($days as $day){
		...
		foreach($attributes as $value){
			...
			if(isset($_POST[$col])){
				...
				//we don't change values we already have.
	...
	//set default value for fields and link to css.
	//if attribute == 1 then this label...
	//else if attribute == 0 then this label...
	//same css but reversed.
...
<html>
	...
	<h2>View and Weekly Schedule</h2>
